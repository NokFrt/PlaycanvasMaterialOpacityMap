...
declare namespace pc {
    ...
    function QuadraticIn(k: number): number;
    function QuadraticOut(k: number): number;
    function QuadraticInOut(k: number): number;
    function CubicIn(k: number): number;
    function CubicOut(k: number): number;
    function CubicInOut(k: number): number;
    function QuarticIn(k: number): number;
    function QuarticOut(k: number): number;
    function QuarticInOut(k: number): number;
    function QuinticIn(k: number): number;
    function QuinticOut(k: number): number;
    function QuinticInOut(k: number): number;
    function SineIn(k: number): number;
    function SineOut(k: number): number;
    function SineInOut(k: number): number;
    function ExponentialIn(k: number): number;
    function ExponentialOut(k: number): number;
    function ExponentialInOut(k: number): number;
    function CircularIn(k: number): number;
    function CircularOut(k: number): number;
    function CircularInOut(k: number): number;
    function ElasticIn(k: number): number;
    function ElasticOut(k: number): number;
    function ElasticInOut(k: number): number;
    function BackIn(k: number): number;
    function BackOut(k: number): number;
    function BackInOut(k: number): number;
    function BounceIn(k: number): number;
    function BounceOut(k: number): number;
    function BounceInOut(k: number): number;



    /**
     * 1. Call Application.addTweenManager() to enable tweening.
     * 2. Use Entity.tween() or Application.tween() to create a new tween.
     * More examples at: https://github.com/playcanvas/playcanvas-tween
     */
    class Tween {
        private constructor(target: Object, manager: any, entity: pc.Entity);
        /**
         * 
         * @param properties 
         ...
         * @param yoyo 
         */
        to(properties: Object, duration: number, easing?: Function, delay?: number, repeat?: number, yoyo?: boolean): Tween;
        from(properties: Object, duration: number, easing?: Function, delay?: number, repeat?: number, yoyo?: boolean): Tween;
        rotate(properties: Object, duration: number, easing?: Function, delay?: number, repeat?: number, yoyo?: boolean): Tween;
        /**
        ...
        /**
         * To make a tween play in reverse after it finishes call tween.yoyo(true).
         * Note that to actually see the tween play in reverse in the end, you have to either repeat the tween at least 2 times or set it to loop forever. E.g. to only play a tween from start to end and then from end to start 1 time you need to do: tween.yoyo(true).repeat(2);
         * @param yoyo
         */
    ...
    const enum eCompomentType {
        /**
         * The Animation Component allows an Entity to playback animations on models.
         */
        animation = "animation",
        /**
         * Represents the audio listener in the 3D world, so that 3D positioned audio sources are heard correctly.
         */
        ...
        collision = "collision",
        /**
         * Enables an Entity to be positioned using anchors and screen coordinates under a pc.ScreenComponent or under other ElementComponents.
         */
        element = "element",
        /**
        ...
        model = "model",
        /**
         * Used to simulate particles and produce renderable particle mesh on either CPU or GPU.
         */
     ...
     */
    const enum eModelType {
        /**
         * The component will render a model asset.
         */
        asset = "asset",
        /**
         * The component will render a box (1 unit in each dimension)
         */
        box = "box",
        /**
         * The component will render a capsule (radius 0.5, height 2)
         */
        capsule = "capsule",
        /**
         * The component will render a cone (radius 0.5, height 1)
         */
        cone = "cone",
        /**
         * The component will render a cylinder (radius 0.5, height 1)
         */
        cylinder = "cylinder",
        /**
         * The component will render a plane (1 unit in each dimension).
         */
        plane = "plane",
        /**
         * The component will render a sphere (radius 0.5)
         */
        sphere = "sphere",
    }
    ...
    const enum eCollisionVolumeType {
        /**
         * A box-shaped collision volume.
         */
        box = "box",
        /**
         * A sphere-shaped collision volume.
         */
        sphere = "sphere",
        /**
         * A capsule-shaped collision volume.
         */
        capsule = "capsule",
        /**
         * A cylinder-shaped collision volume.
         */
        cylinder = "cylinder",
        /**
        ...
        cone = "cone",
        /**
         * A collision volume that uses a model asset as its shape.
         */
        mesh = "mesh"
    }
    ...
    class TextureAtlasFrame {
        /**
         * u, v, width and height in pixels
         */
        rect: pc.Vec4;
        /**
         * x, y values between 0-1 which define the point within the frame around which rotation and scale is calculated
         */
        pivot: pc.Vec2;
        /**
    ...
    * {@link pc.TYPE_FLOAT32}
    ...
    class MeshInstance {
        ...
        /**
        * Set a specific value in the shader
        * @param parName uniform variable name
        * @param value 
        */
        setParameter(parName: string, value: Float32Array | number): void;
        /**
    ...
    * {@link pc.PRIMITIVE_TRIFAN}
     ...
     */
    function calculateNormals(positions: number[] | Float32Array, indices: number[] | Uint16Array | Uint32Array): number[];
    /**
     ...
     */
    function createMesh(device: pc.GraphicsDevice, positions: number[] | Float32Array, opts?: {
